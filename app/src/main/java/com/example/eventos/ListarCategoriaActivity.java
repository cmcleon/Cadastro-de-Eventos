...
public class ListarCategoriaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        excluirOnClickListenerListView_Categoria();
    }
    ...
    private void excluirOnClickListenerListView_Categoria(){
    ...
    public void onClickEventos(View v){
        Intent intent = new Intent(ListarCategoriaActivity.this, MainActivity.class);
        startActivity(intent);
        finish();
    }
}
